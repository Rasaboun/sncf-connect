...
export default function SearchBar({place, setPlace, setPlaceSecond, placesecond}: searchbarProps) {
  ...
  return (
    <div className=" bg-[#0C131F] ">
      <div className="mx-3 flex flex-col space-y-5 pb-4 -z-0 relative pl-1 md:pl-6 pt-9 md:pt-0 ">
      <h1 className="text-white pt-6 text-2xl font-medium">Itinéraires</h1>
      <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 max-w-7xl">
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-[2px] w-full md:w-3/5		 relative items-center">
          <button
            className="h-9 w-9 cursor-pointer   absolute inset-y-0 m-auto md:left-0 right-0 "
          ...
          >
            ...
            <input
              type="text"
              className="truncate bg-[#242b35] outline-none   group-hover:bg-[#8DE8FE]/20 text-white   block w-full p-2.5   "
          ...
          >
            ...
            <input
              type="text"
              className=" truncate bg-[#242b35] outline-none group-hover:bg-[#8DE8FE]/20 text-white   block w-full p-2.5 rounded-r-xl "
        ...
        <button
          className="flex flex-row space-x-7 md:space-x-2 rounded-xl bg-[#242b35] hover:bg-[#8DE8FE]/20 items-center p-3 md:ml-5 w-full md:w-fit"
      ...
      <div className="flex flex-row text-white  space-x-4 pb-4 items-center overflow-auto whitespace-nowrap">
        <p className="text-base font-medium">Filtrer par :</p>
        <button className="inline-flex flex-row rounded-3xl bg-[#242b35] hover:bg-[#8DE8FE]/20 space-x-2 py-1.5 px-3 text-base font-light">
    ...
    <>
      <div className="absolute w-full bg-white inset-x-0 top-28 max-h-96 overflow-auto  md:top-16 rounded-xl flex flex-col z-50 ">
        {props.place.map((elem, id) => (
          <button
            onClick={() => { props.setInputValue(elem.name); props.setPlaceValue(elem) }}
      ...
      <div className="fixed inset-0 top-96 md:top-64 z-40 bg-[#0C131F]/40 	 backdrop-blur-sm "></div>
    </>
  );
}
