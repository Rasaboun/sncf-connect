...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max  items-center justify-center rounded-md bg-[#0C131F] px-1 py-2 text-lg font-medium transition-colors  hover:text-[#8DE8FE]  focus:text-[#8DE8FE] focus:outline-none disabled:pointer-events-none disabled:opacity-50 "
)
